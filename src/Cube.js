                    ...
                    <Card title="О себе" bordered={false} hoverable>
                      <div className="edu_flex">
                        <div className="edu_name2 common-text">
                          ...
                          - Стремлюсь работать в команде профессионалов, где можно обмениваться опытом и расти
                          технически; <br />
                          - Рассматриваю frontend как инженерную задачу, где важно проектировать архитектуру, а не
                          просто писать компоненты; <br />
                          - Люблю разбираться в том, как всё работает "под капотом" — от браузера до сборки; <br />
                          - Ценю чистый, понятный код и продуктивное взаимодействие в команде; <br />
