                                  ...
                                  children: (
                                    <div>
                                      ...
                                      <span className="common-text">
                                        ...
                                        <b>Что делал:</b> <br />- написал раздел "редактор статей базы знаний", что
                                        позволило повысить удобство и временные показатели работы со статьями базы
                                        знаний + замена компонента "Текстовый редактор", использовал этот{" "}
                                        ...
                                        , <br />
                                        - писал компонент, обёрнутый в iframe, и логику для общения с основным окном
                                        (postMessage), <br />- работал с чатом приложения, <br />- участвовал в переносе
                                        проекта на более современный стэк с сохранением старого кода.
                                        <br />
                                  ...
                                  children: (
                                    <div>
                                      ...
                                      <span className="common-text">
                                        ...
                                        <b>Что делал:</b> создавал API с авторизацией и ролями (монолит), которое в
                                        процессе становилось на замену некоторым модулям 1С, в основном CRUD операции с
                                        сортировками, фильтрацией и пагинацией, также занимался разработкой фронтэнда,
                                        довёл до результата такие разделы как "согласования", "склад", "чат".
                                        <br />
